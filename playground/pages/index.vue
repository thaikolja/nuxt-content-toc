...
// Page metadata
useHead({
  title: 'nuxt-content-toc — Table of Contents for Nuxt',
  meta: [
    { name: 'description', content: 'A powerful, accessible Table of Contents module for @nuxt/content v2 and v3' },
  ],
})
</script>
  ...
  <div class="page-wrapper">
    ...
    <header class="site-header">
      <div class="header-content">
        <div class="logo">
          ...
          <span class="version-badge">v3.0.0-alpha-1</span>
        </div>
        <nav class="header-nav">
          <a href="https://github.com/thaikolja/nuxt-content-toc" target="_blank" class="nav-link">
          ...
          <a href="https://npmjs.com/thaikolja/nuxt-content-toc" target="_blank" class="nav-link">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      ...
      <main class="content-main">
        ...
        >
          ...
          <div class="meta-bar">
            ...
            <div class="meta-item">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20M2 12h20"></path></svg>
              <span>v1.0.0</span>
            </div>
            <div class="meta-item">
    ...
    <footer class="site-footer">
      <div class="footer-content">
        <p>Built with <span class="heart">♥</span> for the Nuxt community</p>
        <p class="copyright">MIT License © 2024</p>
      </div>
    </footer>
  </div>
</template>
