...
// Note: Ensure collection name 'content' matches playground/content.config.ts
const { data: page, error: fetchError } = await useAsyncData('index', () => {
      ...
      <div class="header-content">
        ...
        <nav class="header-nav">
          ...
          >
            ...
            GitHub </a> <a
            href="https://npmjs.com/package/nuxt-content-toc"
            target="_blank"
            class="nav-link"
          >
            <svg
    ...
    <div class="main-layout">
      ...
      <main class="content-main">
        <article
          ...
          class="prose"
        >
          <h1>{{ page.title || 'nuxt-content-toc' }}</h1>
        ...
        >
          <p style="color: #ef4444;">
            Error loading documentation: {{ fetchError.message }}
          </p>
        </div>
